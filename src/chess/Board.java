...
public class Board extends JPanel {
    ...
    public void paintComponent (Graphics g) {
        ...
        for (int row = 0; row < 8; row++) {
            for (int col = 0; col < 8; col++) {
                    if (board[row][col].getPiece().getClass().getName().equals("chess.rook.Rook") && !(board[row][col].getPiece().isWhite())) {
                            BufferedImage image;
                            try {
                    ...
                    } else if (board[row][col].getPiece().getClass().getName().equals("chess.rook.Rook") && (board[row][col].getPiece().isWhite())) {
                        BufferedImage image;
                        try {
                ...
                if (board[row][col].getPiece().getClass().getName().equals("chess.pawn.Pawn") && !(board[row][col].getPiece().isWhite())) {
                    BufferedImage image;
                    try {
                ...
                } else if (board[row][col].getPiece().getClass().getName().equals("chess.pawn.Pawn") && (board[row][col].getPiece().isWhite())) {
                    BufferedImage image;
                    try {
                ...
                if (board[row][col].getPiece().getClass().getName().equals("chess.knight.Knight") && !(board[row][col].getPiece().isWhite())) {
                    BufferedImage image;
                    try {
                ...
                } else if (board[row][col].getPiece().getClass().getName().equals("chess.knight.Knight") && (board[row][col].getPiece().isWhite())) {
                    BufferedImage image;
                    try {
                ...
                if (board[row][col].getPiece().getClass().getName().equals("chess.bishop.Bishop") && !(board[row][col].getPiece().isWhite())) {
                    BufferedImage image;
                    try {
                ...
                } else if (board[row][col].getPiece().getClass().getName().equals("chess.bishop.Bishop") && (board[row][col].getPiece().isWhite())) {
                    BufferedImage image;
                    try {
                ...
                if (board[row][col].getPiece().getClass().getName().equals("chess.queen.Queen") && !(board[row][col].getPiece().isWhite())) {
                    BufferedImage image;
                    try {
                ...
                } else if (board[row][col].getPiece().getClass().getName().equals("chess.queen.Queen") && (board[row][col].getPiece().isWhite())) {
                    BufferedImage image;
                    try {
                ...
                if (board[row][col].getPiece().getClass().getName().equals("chess.king.King") && !(board[row][col].getPiece().isWhite())) {
                    BufferedImage image;
                    try {
                ...
                } else if (board[row][col].getPiece().getClass().getName().equals("chess.king.King") && (board[row][col].getPiece().isWhite())) {
                    BufferedImage image;
                    try {
