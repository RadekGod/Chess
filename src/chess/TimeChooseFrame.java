            ...
            if (timerController != null && gameFinishedFrame != null) {
                switch (choice) {
                    case 0 -> {
                        ...
                        gameFrame.getWhiteTimer().setText("Biały czas: 01:00");
                        gameFrame.getBlackTimer().setText("Czarny czas: 01:00");
                    ...
                    case 1 -> {
                        ...
                        TimerController.unlimitedTime = false;
                        timerController.setCount(true);
                        gameFrame.getWhiteTimer().setText("Biały czas: 10:00");
                        gameFrame.getBlackTimer().setText("Czarny czas: 10:00");
                        gameFinishedFrame.resetGame();
                    }
                    case 2 -> {
                        timer = 1800;
                        ...
                        TimerController.unlimitedTime = false;
                        timerController.setCount(true);
                        gameFrame.getWhiteTimer().setText("Biały czas: 30:00");
                        gameFrame.getBlackTimer().setText("Czarny czas: 30:00");
                        gameFinishedFrame.resetGame();
                    }
                    case 3 -> {
                        timer = 3600;
                        ...
                        TimerController.unlimitedTime = false;
                        timerController.setCount(true);
                        gameFrame.getWhiteTimer().setText("Biały czas: 60:00");
                        gameFrame.getBlackTimer().setText("Czarny czas: 60:00");
                        gameFinishedFrame.resetGame();
                    }
                    case 4 -> {
                        timer = -1;
                        ...
                        gameFrame.getWhiteTimer().setText("Biały czas: BEZ LIMITU");
                        gameFrame.getBlackTimer().setText("Czarny czas: BEZ LIMITU");
                        gameFinishedFrame.resetGame();
                    }
                }
            } else {
